...
//!
//! This module provides the [`init`] function that handles initialization of `scaffops`.
...
#[diagnostic(
    code(scaffops::init::change_current_directory),
...
/// Initializes `scaffops`, optionally changing the current directory.
///
/// # Errors
///
